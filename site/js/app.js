...
all_pilots_sql = "CALL GetAllPilots('2023-06-03','2100-01-01', 36)";
all_upgrades_sql = "CALL GetAllUpgrades('2023-06-03','2100-01-01', 36)";
all_factions_sql = "CALL GetAllFactions('2023-06-03','2100-01-01', 36)";
...
app.get("/upgrades/:upgradeslot", (req, res) => {
  ...
  pool.getConnection(function(err, connection) {
    ...
    connection.query(
      ...
      [upgrade, "2023-06-03", "2100-01-01", 36],
