...
all_pilots_sql = "CALL GetAllPilots('2018-01-20','2100-01-01', 1)";
all_upgrades_sql = "CALL GetAllUpgrades('2018-01-20','2100-01-01', 1)";
all_factions_sql = "CALL GetAllFactions('2018-01-20','2100-01-01', 1)";
...
app.get("/upgrades/:upgradeslot", (req, res) => {
  ...
  pool.getConnection(function(err, connection) {
    ...
    connection.query(
      ...
      [upgrade, "2018-01-20", "2100-01-01", 1],
